...
ActiveRecord::Schema[7.0].define(version: 2023_04_08_131559) do
  ...
  create_table "budgets", force: :cascade do |t|
    t.integer "amount"
    t.text "description"
    t.bigint "plan_country_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "category_id", null: false
    t.index ["category_id"], name: "index_budgets_on_category_id"
    t.index ["plan_country_id"], name: "index_budgets_on_plan_country_id"
  end
  ...
  create_table "informations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["country_id"], name: "index_informations_on_country_id"
  end
  ...
  add_foreign_key "budgets", "plan_countries"
  add_foreign_key "informations", "countries"
