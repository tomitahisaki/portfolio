...
ActiveRecord::Schema[7.0].define(version: 20_230_302_061_849) do
  ...
  create_table 'plan_countries', force: :cascade do |t|
    ...
    t.index %w[plan_id country_id], name: 'index_plan_countries_on_plan_id_and_country_id', unique: true
